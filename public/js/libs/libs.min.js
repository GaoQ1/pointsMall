...
},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var on=e.jQuery,an=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=an),t&&e.jQuery===ie&&(e.jQuery=on),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie});document.addEventListener("DOMContentLoaded", function () {function t(e, t, n, a) {e.style.height = parseInt(v * n * a / t) + "px"}var d = document, s = d.getElementById("classify"), g = (s.getElementsByTagName("div"), d.getElementById("gold")), v = (d.getElementById("iphone"), d.getElementsByTagName("body")[0], document.documentElement.clientWidth);t(g, 140, 174, .4);}, !1);
